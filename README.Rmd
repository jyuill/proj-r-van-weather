...
Data is shown below in various charts. Also available in other forms in this repo:

1. **van-weather-report**: deep-dive into weather stats, with some light modeling.
2. **van-weather-dashboard**: flexdashboard showing 30d, 90d, annual weather patterns
